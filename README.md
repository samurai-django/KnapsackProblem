...
<h2>(2-1) C は 300(g)プラスマイナス50(g)以内</h2>

<h2>(2-2) C = 300(g)，必ず飴は1種類以上持っていく</h2>  
<h2>(2-3) C = 300(g)，果物を持っていく場合は3種類以上</h2>  
<h2>(2-4) C = 300(g)，ガム80g以下ならばチョコレートは150g以上<h2>

<h2>(3-1) 価値をy円になるべく近づける</h2>  
